...
function cargar_formulario_044($req_no,$process,$activity,$cedula,$username){    
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="padding:5px 0 0 30px;">
                        <div class="col-xs-5 form-group">
                            ...
                            <input type="text" class="form-control" name="req_no" readonly value="'.$tninp044->getReq_no().'" />                                    
                        </div>
