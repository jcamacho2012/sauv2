...
function cargar_formulario_014($req_no){      
    ...
    $retval=' 
                    ...
                    <div class="panel-body">
                         <div class="row" style="padding:5px 0 0 30px;">
                            <div class="col-xs-5 form-group">
                                ...
                                <input type="text" class="form-control" name="req_no" readonly value="'.$tninp014->getReq_no().'" />                                    
                            </div>
			...
			<div class="col-xs-11 form-group" style="padding:5px 0 0 30px;">
                            ...
                            <input type="text" class="form-control" name="expr_nm" readonly value="'.$tninp014->getExpr_ad().'"  />
                        </div>
			<div class="col-xs-11 form-group" style="padding:5px 0 0 30px;">
			...
			<div class="col-xs-11 form-group" style="padding:5px 0 0 30px;">
                            ...
                            <input type="text" class="form-control" name="impr_nm" readonly value="'.$tninp014->getImpr_ad().'"  />
                        </div>
			<div class="row" style="padding:5px 0 0 30px;">
                            <div class="col-xs-5 form-group">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="col-xs-11 form-group">
                            ...
                            <textarea class="form-control" rows="5" name="dclr_rmk">'.$tninp014->getDclr_rmk().'</textarea>
                        </div>
                        <div class="col-xs-11 form-group">
