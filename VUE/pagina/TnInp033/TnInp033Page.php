...
function cargar_formulario_033($req_no,$process,$activity,$cedula,$username){    
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="padding:5px 0 0 30px;">
                            <div class="col-xs-5 form-group">
                                ...
                                <input type="text" class="form-control" name="req_no" readonly value="'.$tninp033->getReq_no().'" />                                    
                            </div>
