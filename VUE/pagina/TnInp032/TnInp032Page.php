...
function cargar_formulario_032($req_no,$process,$activity,$cedula,$username){    
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="padding:5px 0 0 30px;">
                            <div class="col-xs-5 form-group">
                                ...
                                <input type="text" class="form-control" name="req_no" readonly value="'.$tninp032->getReq_no().'" />                                    
                            </div>
	...
	$retval.='
			...
			<div class="row" style="padding:5px 0 0 30px;">
                            ...
                            <div class="col-xs-5 form-group">
                                ...
                                <input type="text" class="form-control" name="prdt_perox_index" readonly value="'.$tninp032->getPrdt_perox_index().'"  />
                            </div>
                        </div>
			<div class="row" style="padding:5px 0 0 30px;">
                            <div class="col-xs-5 form-group">
                                <label>Indice de Peróxido meq de Oxígeno /kg. max 10%</label>                                      
                                <input type="text" class="form-control" name="prdt_acidez" readonly value="'.$tninp032->getPrdt_acidez().'" />                                    
                            </div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="col-xs-11 form-group">
                            ...
                            <textarea class="form-control" rows="5" name="dclr_rmk">'.$tninp032->getDclr_rmk().'</textarea>
                        </div>
                        <div class="col-xs-11 form-group">
