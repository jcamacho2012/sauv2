...
class TnInp027VO{
    ...
    function __construct($array) {
        ...
        $this->rqt_motv = $array['rqt_motv'];
        $this->dst_ntn_nm = $array['dst_ntn_nm'];
        $this->pck_tot_qt=number_format($array['pck_tot_qt'],2)." ".$array['pck_tot_qt_ut'];        
    ...
    function getRqt_motv() {
        return $this->rqt_motv;
    }
    ...
    function setRqt_motv($rqt_motv) {
        $this->rqt_motv = $rqt_motv;
    }
    ...
    function setPck_tot_qt($pck_tot_qt) {
